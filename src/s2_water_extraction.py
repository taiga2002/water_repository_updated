...
from sentinelhub import WcsRequest, MimeType, CustomUrlParam, DataCollection
from sentinelhub import DownloadFailedException
from sentinelhub.exceptions import ImageDecodingError
from s2cloudless import CloudMaskRequest, S2PixelCloudDetector
...
def extract_surface_water_area_per_frame(dam_id, dam_poly, dam_bbox, date, resx, resy):
    ...
    try:
        ...
        all_cloud_masks = CloudMaskRequest(cloud_detector = cloud_detector, bbox= dam_bbox, time = new_date)
